...
set_type = "exist"
train_mode = "ours" # baseline or 3way or ours
teacher =True
...
if train_mode == "ours":
    print(f"3way training mode is selected...\n\n\n")
MP = 50
backbone = "MLPD"

num_p = None
if MP == 30:  num_p = "006" if dataset_type == "KAIST" else "005"
elif MP == 50: num_p = "013" if dataset_type == "KAIST" else "005"
elif MP == 70: num_p = "010" if dataset_type == "KAIST" else "006"
assert num_p is not None, "Incorrect MP..."
# pretrained = f"../pretrained/ours/{dataset_type}_{MP}.pth.tar000"


pretrained = f"../pretrained/3way_base/{dataset_type}_pretrained_3way_{MP}.pth.tar{num_p}"
